...
! function(t, e) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.VueMasonry = e()
}(this, function() {
  "use strict";
  var t = function(t, e) {
      if (parseInt(t) > -1) return t;
      ...
      for (var r in t) {
        var o = parseInt(r),
          s = t[o],
          u = parseInt(s);
        isNaN(o) || isNaN(u) || e <= o && o < n && (n = o, i = s)
      }
      return i
    },
    e = {
      ...
      methods: {
        ...
        _reCalculateGutterSize: function(e) {
          this.displayGutter = t(this.gutter, e)
        },
        _reCalculateColumnCount: function(e) {
          var n = t(this.cols, e);
          n = Math.max(1, Number(n) || 0), this.displayColumns = n
        },
        _getChildItemsInColumnsArray: function() {
          ...
          for (var i = 0, r = 0; i < n.length; i++, r++)
            if (n[i].tag) {
              var o = r % t.displayColumns;
              e[o] || (e[o] = []), e[o].push(n[i])
            } else r--;
          return e
        }
      },
      render: function(t) {
        var e = this,
          ...
          i = parseInt(this.displayGutter) === 1 * this.displayGutter ? this.displayGutter + "px" : this.displayGutter,
          r = {
  ...
  return n.install = function(t, i) {
    n.installed || (i && i.name ? t.component(i.name, e) : t.component("masonry", e))
